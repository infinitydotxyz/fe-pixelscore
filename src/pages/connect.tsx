  ...
  return (
    <PageBox extraScrollHeight={false} pageClass="min-h-screen" className="grid place-content-center">
      <div className="flex flex-col gap-2 items-center">
        <div className="dark:shadow-dark-blue shadow-light-blue shadow-sm dark:border-dark-border border-light-border border-t border-b border-l border-r rounded-3xl flex flex-col items-center mx-0 my-4 px-12 py-8 dark:text-dark-body text-light-body">
